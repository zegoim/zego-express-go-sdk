...
ZEGOEXP_API zego_error EXP_CALL zego_express_start_recording_captured_data(
    zego_handle handle, struct zego_data_record_config config, enum zego_publish_channel channel);
#else
...
zego_express_stop_recording_captured_data(zego_handle handle, enum zego_publish_channel channel);
#else
...
#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API zego_error EXP_CALL zego_express_start_recording_remote_data(
    zego_handle handle, struct zego_data_record_config config, const char *stream_id);
#else
typedef zego_error(EXP_CALL *pfnzego_express_start_recording_remote_data)(
    zego_handle handle, struct zego_data_record_config config, const char *stream_id);
#endif
...
/// @param stream_id play stream id.
#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API zego_error EXP_CALL zego_express_stop_recording_remote_data(zego_handle handle,
                                                                        const char *stream_id);
#else
typedef zego_error(EXP_CALL *pfnzego_express_stop_recording_remote_data)(zego_handle handle,
                                                                         const char *stream_id);
#endif
...
typedef void (*zego_on_captured_data_record_state_update)(
    zego_handle handle, enum zego_data_record_state state, zego_error error_code,
    struct zego_data_record_config config, enum zego_publish_channel channel, void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_captured_data_record_state_update_callback(
    zego_handle handle, zego_on_captured_data_record_state_update callback_func,
    void *user_context);
#else
...
typedef void (*zego_on_captured_data_record_progress_update)(
    zego_handle handle, struct zego_data_record_progress progress,
    struct zego_data_record_config config, enum zego_publish_channel channel, void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_captured_data_record_progress_update_callback(
    zego_handle handle, zego_on_captured_data_record_progress_update callback_func,
    void *user_context);
#else
...
/// @param stream_id play stream id.
/// @param user_context Context of user.
typedef void (*zego_on_remote_data_record_state_update)(zego_handle handle,
                                                        enum zego_data_record_state state,
                                                        zego_error error_code,
                                                        struct zego_data_record_config config,
                                                        const char *stream_id, void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_remote_data_record_state_update_callback(
    zego_handle handle, zego_on_remote_data_record_state_update callback_func, void *user_context);
#else
typedef void(EXP_CALL *pfnzego_register_remote_data_record_state_update_callback)(
    zego_handle handle, zego_on_remote_data_record_state_update callback_func, void *user_context);
#endif
...
/// @param user_context Context of user.
typedef void (*zego_on_remote_data_record_progress_update)(
    zego_handle handle, struct zego_data_remote_record_progress progress,
    struct zego_data_record_config config, const char *stream_id, void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_remote_data_record_progress_update_callback(
    zego_handle handle, zego_on_remote_data_record_progress_update callback_func,
    void *user_context);
#else
typedef void(EXP_CALL *pfnzego_register_remote_data_record_progress_update_callback)(
    zego_handle handle, zego_on_remote_data_record_progress_update callback_func,
    void *user_context);
#endif
