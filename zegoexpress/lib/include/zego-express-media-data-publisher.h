...
ZEGOEXP_API zego_error EXP_CALL zego_express_create_media_data_publisher(
    zego_handle handle, struct zego_media_data_publisher_config config,
...
zego_express_destroy_media_data_publisher(zego_handle handle, zego_instance instance_index);
#else
typedef zego_error(EXP_CALL *pfnzego_express_destroy_media_data_publisher)(
    zego_handle handle, zego_instance instance_index);
#endif
...
ZEGOEXP_API zego_error EXP_CALL zego_express_media_data_publisher_add_media_file_path(
    zego_handle handle, const char *path, bool is_clear, zego_instance instance_index);
#else
...
#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API zego_error EXP_CALL
zego_express_media_data_publisher_reset(zego_handle handle, zego_instance instance_index);
#else
...
ZEGOEXP_API zego_error EXP_CALL zego_express_media_data_publisher_set_video_send_delay_time(
    zego_handle handle, int delay_time, zego_instance instance_index);
#else
...
ZEGOEXP_API zego_error EXP_CALL zego_express_media_data_publisher_seek_to(
    zego_handle handle, unsigned long long millisecond, zego_instance instance_index);
#else
...
ZEGOEXP_API zego_error EXP_CALL zego_express_media_data_publisher_get_total_duration(
    zego_handle handle, zego_instance instance_index, unsigned long long *total_duration);
#else
...
ZEGOEXP_API zego_error EXP_CALL zego_express_media_data_publisher_get_current_duration(
    zego_handle handle, zego_instance instance_index, unsigned long long *current_duration);
#else
...
typedef void (*zego_on_media_data_publisher_file_open)(zego_handle handle, const char *path,
                                                       zego_instance instance_index,
                                                       void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_media_data_publisher_file_open_callback(
    zego_handle handle, zego_on_media_data_publisher_file_open callback_func, void *user_context);
#else
...
/// @param instance_index Media data publisher instance index
/// @param user_context Context of user.
typedef void (*zego_on_media_data_publisher_file_close)(zego_handle handle, zego_error error_code,
                                                        const char *path,
                                                        zego_instance instance_index,
                                                        void *user_context);
...
ZEGOEXP_API void EXP_CALL zego_register_media_data_publisher_file_close_callback(
    zego_handle handle, zego_on_media_data_publisher_file_close callback_func, void *user_context);
#else
...
/// @param instance_index Media data publisher instance index
/// @param user_context Context of user.
typedef void (*zego_on_media_data_publisher_file_data_begin)(zego_handle handle, const char *path,
                                                             zego_instance instance_index,
                                                             void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_media_data_publisher_file_data_begin_callback(
    zego_handle handle, zego_on_media_data_publisher_file_data_begin callback_func,
    void *user_context);
#else
...
/// @param instance_index Media data publisher instance index
/// @param user_context Context of user.
typedef void (*zego_on_media_data_publisher_file_data_end)(zego_handle handle, const char *path,
                                                           zego_instance instance_index,
                                                           void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_media_data_publisher_file_data_end_callback(
    zego_handle handle, zego_on_media_data_publisher_file_data_end callback_func,
    void *user_context);
#else
