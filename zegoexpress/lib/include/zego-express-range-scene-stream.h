...
typedef void (*zego_on_range_scene_stream_user_stream_state_update)(
    zego_handle handle, int range_scene_handle, const char *userid, const char *stream_id,
    enum zego_stream_state state, void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_range_scene_stream_user_stream_state_update_callback(
    zego_handle handle, zego_on_range_scene_stream_user_stream_state_update callback_func,
    void *user_context);
#else
...
/// @param user_context Context of user.
typedef void (*zego_on_range_scene_stream_user_mic_update)(zego_handle handle,
...
ZEGOEXP_API void EXP_CALL zego_register_range_scene_stream_user_mic_update_callback(
    zego_handle handle, zego_on_range_scene_stream_user_mic_update callback_func,
    void *user_context);
#else
...
/// @param state Device state.
/// @param user_context Context of user.
typedef void (*zego_on_range_scene_stream_user_camera_update)(zego_handle handle,
                                                              int range_scene_handle,
                                                              const char *userid,
                                                              enum zego_device_state state,
                                                              void *user_context);
...
ZEGOEXP_API void EXP_CALL zego_register_range_scene_stream_user_camera_update_callback(
    zego_handle handle, zego_on_range_scene_stream_user_camera_update callback_func,
    void *user_context);
#else
...
/// @param state Device state.
/// @param user_context Context of user.
typedef void (*zego_on_range_scene_stream_user_speaker_update)(zego_handle handle,
                                                               int range_scene_handle,
                                                               const char *userid,
                                                               enum zego_device_state state,
                                                               void *user_context);
...
ZEGOEXP_API void EXP_CALL zego_register_range_scene_stream_user_speaker_update_callback(
    zego_handle handle, zego_on_range_scene_stream_user_speaker_update callback_func,
    void *user_context);
#else
