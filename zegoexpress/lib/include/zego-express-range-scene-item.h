...
ZEGOEXP_API zego_error EXP_CALL zego_express_range_scene_item_create_item(
    zego_handle handle, int range_scene_handle, zego_seq *seq, struct zego_item_param param);
#else
...
/// @return Error code, please refer to the error codes document https://doc-en.zego.im/en/5548.html for details.
#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API zego_error EXP_CALL zego_express_range_scene_item_destroy_item(zego_handle handle,
                                                                           int range_scene_handle,
                                                                           zego_seq *seq,
                                                                           long long item_id);
#else
typedef zego_error(EXP_CALL *pfnzego_express_range_scene_item_destroy_item)(zego_handle handle,
                                                                            int range_scene_handle,
                                                                            zego_seq *seq,
                                                                            long long item_id);
#endif
...
/// @return Error code, please refer to the error codes document https://doc-en.zego.im/en/5548.html for details.
#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API zego_error EXP_CALL zego_express_range_scene_item_bind_item(zego_handle handle,
                                                                        int range_scene_handle,
                                                                        zego_seq *seq,
                                                                        long long item_id);
#else
typedef zego_error(EXP_CALL *pfnzego_express_range_scene_item_bind_item)(zego_handle handle,
                                                                         int range_scene_handle,
                                                                         zego_seq *seq,
                                                                         long long item_id);
#endif
...
/// @return Error code, please refer to the error codes document https://doc-en.zego.im/en/5548.html for details.
#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API zego_error EXP_CALL zego_express_range_scene_item_unbind_item(zego_handle handle,
                                                                          int range_scene_handle,
                                                                          zego_seq *seq,
                                                                          long long item_id);
#else
typedef zego_error(EXP_CALL *pfnzego_express_range_scene_item_unbind_item)(zego_handle handle,
                                                                           int range_scene_handle,
                                                                           zego_seq *seq,
                                                                           long long item_id);
#endif
...
ZEGOEXP_API zego_error EXP_CALL zego_express_range_scene_item_update_item_status(
    zego_handle handle, int range_scene_handle, zego_seq *seq, long long item_id,
    struct zego_position position, unsigned int channel, const unsigned char *status,
...
ZEGOEXP_API zego_error EXP_CALL zego_express_range_scene_item_update_item_command(
    zego_handle handle, int range_scene_handle, zego_seq *seq, long long item_id,
    struct zego_position position, unsigned int channel, const unsigned char *command,
...
typedef void (*zego_on_range_scene_item_item_enter_view)(zego_handle handle, int range_scene_handle,
                                                         long long item_id, unsigned int capacity,
...
ZEGOEXP_API void EXP_CALL zego_register_range_scene_item_item_enter_view_callback(
    zego_handle handle, zego_on_range_scene_item_item_enter_view callback_func, void *user_context);
#else
...
/// @param item_id Item ID.
/// @param user_context Context of user.
typedef void (*zego_on_range_scene_item_item_leave_view)(zego_handle handle, int range_scene_handle,
                                                         long long item_id, void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_range_scene_item_item_leave_view_callback(
    zego_handle handle, zego_on_range_scene_item_item_leave_view callback_func, void *user_context);
#else
...
/// @param user_context Context of user.
typedef void (*zego_on_range_scene_item_item_bind_update)(zego_handle handle,
                                                          int range_scene_handle, long long item_id,
                                                          const char *userid, void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_range_scene_item_item_bind_update_callback(
    zego_handle handle, zego_on_range_scene_item_item_bind_update callback_func,
    void *user_context);
#else
...
/// @param user_context Context of user.
typedef void (*zego_on_range_scene_item_item_unbind_update)(
    zego_handle handle, int range_scene_handle, long long item_id, const char **user_list,
    unsigned int user_list_size, void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_range_scene_item_item_unbind_update_callback(
    zego_handle handle, zego_on_range_scene_item_item_unbind_update callback_func,
    void *user_context);
#else
...
typedef void (*zego_on_range_scene_item_item_status_update)(
    zego_handle handle, int range_scene_handle, long long item_id, struct zego_position position,
...
ZEGOEXP_API void EXP_CALL zego_register_range_scene_item_item_status_update_callback(
    zego_handle handle, zego_on_range_scene_item_item_status_update callback_func,
    void *user_context);
#else
...
ZEGOEXP_API void EXP_CALL zego_register_range_scene_item_item_command_update_callback(
    zego_handle handle, zego_on_range_scene_item_item_command_update callback_func,
    void *user_context);
#else
...
/// @param item_id Item ID.
/// @param user_context Context of user.
typedef void (*zego_on_range_scene_item_create_item)(zego_handle handle, int range_scene_handle,
                                                     zego_seq seq, int error_code,
                                                     long long item_id, void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_range_scene_item_create_item_callback(
    zego_handle handle, zego_on_range_scene_item_create_item callback_func, void *user_context);
#else
...
/// @param item_id Item ID.
/// @param user_context Context of user.
typedef void (*zego_on_range_scene_item_destroy_item)(zego_handle handle, int range_scene_handle,
                                                      zego_seq seq, int error_code,
                                                      long long item_id, void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_range_scene_item_destroy_item_callback(
    zego_handle handle, zego_on_range_scene_item_destroy_item callback_func, void *user_context);
#else
...
/// @param item_id Item ID.
/// @param user_context Context of user.
typedef void (*zego_on_range_scene_item_bind_item)(zego_handle handle, int range_scene_handle,
                                                   zego_seq seq, int error_code, long long item_id,
                                                   void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_range_scene_item_bind_item_callback(
    zego_handle handle, zego_on_range_scene_item_bind_item callback_func, void *user_context);
#else
...
/// @param item_id Item ID.
/// @param user_context Context of user.
typedef void (*zego_on_range_scene_item_unbind_item)(zego_handle handle, int range_scene_handle,
                                                     zego_seq seq, int error_code,
                                                     long long item_id, void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_range_scene_item_unbind_item_callback(
    zego_handle handle, zego_on_range_scene_item_unbind_item callback_func, void *user_context);
#else
...
/// @param item_id Item ID.
/// @param user_context Context of user.
typedef void (*zego_on_range_scene_item_update_item_status)(zego_handle handle,
...
ZEGOEXP_API void EXP_CALL zego_register_range_scene_item_update_item_status_callback(
    zego_handle handle, zego_on_range_scene_item_update_item_status callback_func,
    void *user_context);
#else
...
/// @param item_id Item ID.
/// @param user_context Context of user.
typedef void (*zego_on_range_scene_item_update_item_command)(zego_handle handle,
                                                             int range_scene_handle, zego_seq seq,
                                                             int error_code, long long item_id,
                                                             void *user_context);
...
ZEGOEXP_API void EXP_CALL zego_register_range_scene_item_update_item_command_callback(
    zego_handle handle, zego_on_range_scene_item_update_item_command callback_func,
    void *user_context);
#else
